# HERO-68127 Report - TMS024 Waiting List Extraction - Add Syndicate Owner Indicator field Test Report

## Report Information

| Field | Value |
| --- | --- |
| Name | Waiting List Extraction Report |
| Code | TMS024 |
| Type | Improvement |
...
**Step(s):**
  1. Open TMS024 report and run with default parameters
...
**Prerequisite(s):**
  1. Users with different roles who can currently view TMS024 are available

**Step(s):**
  1. Log in as a user with standard access to TMS024
  2. Open and run TMS024 report
  3. Verify the "Syndicate Owner Indicator" column is visible
  4. Log in as another user with access to TMS024
  5. Verify the column is visible

**Test Result(s):**
  1. All users who can view TMS024 can see the "Syndicate Owner Indicator" column
...
**Step(s):**
  1. Open TMS024 report in Google Chrome, run with default parameters
