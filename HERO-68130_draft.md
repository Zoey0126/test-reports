# HERO-68130 Report - TMS035 Waiting List Report (Owner Box) - Add Syndicate Owner Indicator field Test Report

## Report Information

| Field | Value |
| --- | --- |
| Name | Waiting List Report (Owner Box) Report |
| Code | TMS035 |
| Type | Improvement |
...
**Step(s):**
  1. Open TMS035 Waiting List Report (Owner Box) Report
...
**Step(s):**
  1. Open TMS035 report and run with default parameters
...
**Prerequisite(s):**
  1. Users with different roles who can currently view TMS035 are available

**Step(s):**
  1. Log in as a user with standard access to TMS035
  2. Open and run TMS035 report
  3. Verify the "Syndicate Owner Indicator" column is visible
  4. Log in as another user with access to TMS035
  5. Verify the column is visible

**Test Result(s):**
  1. All users who can view TMS035 can see the "Syndicate Owner Indicator" column
...
**Step(s):**
  1. Open TMS035 report in Google Chrome, run with default parameters
