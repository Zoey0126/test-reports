# HERO-68125 Report - TMS020 Waiting List Report - Add Syndicate Owner Indicator field Test Report

## Report Information

| Field | Value |
| --- | --- |
| Name | Waiting List Report Report |
| Code | TMS020 |
| Type | Improvement |
...
**Step(s):**
  1. Open TMS020 Waiting List Report Report
...
**Step(s):**
  1. Open TMS020 report and run with default parameters
...
**Prerequisite(s):**
  1. Users with different roles who can currently view TMS020 are available

**Step(s):**
  1. Log in as a user with standard access to TMS020
  2. Open and run TMS020 report
  3. Verify the "Syndicate Owner Indicator" column is visible
  4. Log in as another user with access to TMS020
  5. Verify the column is visible

**Test Result(s):**
  1. All users who can view TMS020 can see the "Syndicate Owner Indicator" column
...
**Step(s):**
  1. Open TMS020 report in Google Chrome, run with default parameters
