# HERO-68120 Report - TMS009 Special Booking List (By Outlet) - Add Syndicate Owner Indicator field Test Report

## Report Information

| Field | Value |
| --- | --- |
| Name | Special Booking List (By Outlet) Report |
| Code | TMS009 |
| Type | Improvement |
...
**Step(s):**
  1. Open TMS009 Special Booking List (By Outlet) Report
...
**Step(s):**
  1. Open TMS009 report and run with default parameters
...
**Prerequisite(s):**
  1. Users with different roles who can currently view TMS009 are available

**Step(s):**
  1. Log in as a user with standard access to TMS009
  2. Open and run TMS009 report
  3. Verify the "Syndicate Owner Indicator" column is visible
  4. Log in as another user with access to TMS009
  5. Verify the column is visible

**Test Result(s):**
  1. All users who can view TMS009 can see the "Syndicate Owner Indicator" column
...
**Step(s):**
  1. Open TMS009 report in Google Chrome, run with default parameters
